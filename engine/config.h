...
// =======================================================
// Audio (Buzzer) Configuration
// =======================================================
// Basic UI / game audio output (passive piezo buzzer).
// The initial integration uses short "UI tick" tones as a testing ground.
//
// Pin selection notes:
// - Avoid pins already used by HUB75 (see above).
// - Avoid SPI flash pins (GPIO6..GPIO11).
// - Avoid input-only pins (GPIO34..GPIO39).
// - Avoid boot strap pins where possible (GPIO0, GPIO2, GPIO12, GPIO15).
//
// Default: GPIO33 is free in this project and is commonly safe on ESP32-WROOM dev boards.
#define ENABLE_AUDIO 1
#define AUDIO_BUZZER_PIN 33
